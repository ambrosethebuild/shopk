    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `products` (`id` INTEGER, `vendorId` INTEGER, `name` TEXT, `photoUrl` TEXT, `price` REAL, `discountPrice` REAL, `priceWithExtras` REAL, `selectedQuantity` INTEGER, `description` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
...
class _$CurrencyDao extends CurrencyDao {
  ...
  @override
  Future<Currency> findLatestCurrency() async {
    return _queryAdapter.query('SELECT * FROM currencies LIMIT 1',
...
class _$VendorDao extends VendorDao {
  ...
  static final _vendorsMapper = (Map<String, dynamic> row) => Vendor(
      ...
      deliveryRange: row['deliveryRange'] as double,
